...
namespace CrossCutting.Core.Extensions
{
    ...
    public static class DateTimeExtensions
    {
        ...
        public static string DateToString(this DateTime datetime,string format= "MM/dd/yyyy")
        {
            return datetime == null ? string.Empty : datetime.ToString(format, new CultureInfo("en-US"));
        }
